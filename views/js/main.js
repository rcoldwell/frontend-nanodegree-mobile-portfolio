...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    for (var i = 0; i < document.getElementsByClassNameName(".randomPizzaContainer").length; i++) {
      var dx = determineDx(document.getElementsByClassNameName(".randomPizzaContainer")[i], size);
      var newwidth = (document.getElementsByClassNameName(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';
      document.getElementsByClassNameName(".randomPizzaContainer")[i].style.width = newwidth;
    }
  }
